...
const country_entity_1 = require("../src/modules/country/entities/country.entity");
const countries = [
    {
        code: 'AF',
        name: 'Afghanistan',
        country_code: '+93',
        status: country_entity_1.CountryStatuses.IN_ACTIVE,
    },
    {
        code: 'AL',
        name: 'Albania',
...
const createCountries = async (AppDataSource) => {
    ...
    for (const { name, code, country_code, status } of countries) {
        ...
        if (!isCountryAlreadyExist) {
            const country = countryRepository.create({
                ...
                code,
                country_code,
                status: country_entity_1.CountryStatuses[status],
            });
            await country.save();
        }
    }
