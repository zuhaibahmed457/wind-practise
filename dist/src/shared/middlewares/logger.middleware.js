...
let LoggerMiddleware = class LoggerMiddleware {
    constructor(requestResponseTimeRepository) {
        this.requestResponseTimeRepository = requestResponseTimeRepository;
    }
    use(req, res, next) {
...
exports.LoggerMiddleware = LoggerMiddleware = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(request_response_time_entity_1.RequestResponseTime)),
